...
Nous allons effectuer une regression l2 pénalisée avec Ridge. Nous choisissons le \(\lambda\) par cross validation.
...
Nous allons effectuer une regression l1 pénalisée avec Lasso. Nous choisissons le \(\lambda\) par cross validation.
